...
const activeTab = ref('login') // 默认显示登录
...
.system-title { color: #409EFF; text-align: center; margin-bottom: 25px; font-weight: 600; }
.full-btn { width: 100%; font-weight: bold; font-size: 16px; margin-top: 10px; }
.tips { margin-top: 20px; font-size: 12px; color: #999; text-align: center; background: #f4f4f5; padding: 8px; border-radius: 4px; }
</style>